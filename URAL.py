...
# Port C: Lego 22169 L Motor (servo mode for steering)
# Port D: Lego 88005 Light
...
while True:
    ...
    # Light Switch
    if (Button.RIGHT in pressed) and (lightstatus == 0):
        light.on(100)
        lightstatus = 1
        print('Lights on')
        wait(400)
    elif (Button.RIGHT in pressed) and (lightstatus == 1):
        lightstatus = 0
        light.off()
        print('Lights off')
        wait(400)
